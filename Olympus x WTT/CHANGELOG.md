...
## [Version: 4.1.3.9]
Changes:
  * Fix: Missing helper files in mod directory.
  * Fix: Damage and Health effects applied to stims.
  * Fix: Squashed "Hands are busy" bug when using stims.
  * Fix: Buffs applied to stims.
  * Fix: Firearm association for magazines.
  * Update: Stim properties

Thanks:
  * Contributor: FLIGHTxS4L

---

## [Version: 4.1.3]
Changes:
  * Update: Support SPT 4.1.3+ on EFT Version 0.16.9.5.40743
  * Update: Minor code optimizations.
  * Add: Experimental new blacklisting options.
...
## [Version: 4.0.11]
> Type: LTS (Long-Term Support)</br>
> Release Date: January 27, 2026</br>
> Title: The Olympians Update

### Code Changes
- Update all mod code to be compatible with current SPT 4.0.0+ server code.
- Attempt made at modularizing as much of the code as possible for future proofing.
...
# Changes After This Line Are No Longer Supported
### ----------------------------------------------------------------------------------------------------------------------------
